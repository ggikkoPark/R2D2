...
//        csvParser = new CSVParser(fileReader, csvFormat);
    ...
    private static List<String> filterUselessData(List<String> blogDataList) {
        ...
        //TODO : List화 하여 필터링 해야함
        List<String> collect = blogDataList.parallelStream()
                .filter(s -> !s.contains("맛집"))
                .filter(s -> !s.contains("파스타"))
                .filter(s -> !s.contains("카페"))
                .filter(s -> !s.contains("맛집"))
                .filter(s -> !s.contains("피자"))
                .filter(s -> !s.contains("햄버거"))
                .filter(s -> !s.contains("치킨"))
                .filter(s -> !s.contains("강남"))
                .filter(s -> !s.contains("순대국"))
                .filter(s -> !s.contains("맥주"))
                .filter(s -> !s.contains("쌈밥"))
                .filter(s -> !s.contains("맛있는"))
                .filter(s -> !s.contains("도시락"))
                .filter(s -> !s.contains("줗은"))
                .filter(s -> !s.contains("있는"))
                .filter(s -> !s.contains("역삼동"))
                .filter(s -> !s.contains("최고"))
                .filter(s -> !s.contains("식당"))
                .filter(s -> !s.contains("맛나는"))
                .filter(s -> !s.contains("냉면"))
                .filter(s -> !s.contains("먹고"))
                .filter(s -> !s.contains("전문점"))
                .filter(s -> !s.contains("청국장"))
                .filter(s -> !s.contains("감자탕"))
                .filter(s -> !s.contains("술집"))
                .filter(s -> !s.contains("김밥"))
                .filter(s -> !s.contains("생고기"))
                .filter(s -> !s.contains("왕돈까스"))
                .filter(s -> !s.contains("역삼"))
                .filter(s -> !s.contains("불고기"))
                .filter(s -> !s.contains("좋은"))
                .filter(s -> !s.contains("돈부리"))
                .filter(s -> !s.contains("한우"))
                .filter(s -> !s.contains("정식"))
                .filter(s -> !s.contains("스타일"))
                .filter(s -> !s.contains("찜닭"))
                .filter(s -> !s.contains("나무"))
                .filter(s -> !s.contains("집밥"))
                .filter(s -> !s.contains("서울"))
                .filter(s -> !s.contains("쌀국수"))
                .filter(s -> !s.contains("낙지"))
                .filter(s -> !s.contains("삼성"))
                .filter(s -> !s.contains("나는"))
                .filter(s -> !s.contains("칼국수"))
                .filter(s -> !s.contains("흙돼지"))
                .filter(s -> !s.contains("샐러드"))
                .filter(s -> !s.contains("카레"))
                .filter(s -> !s.contains("오늘"))
                .filter(s -> !s.contains("돈까스"))
                .filter(s -> !s.contains("샤브샤브"))
                .filter(s -> !s.contains("커피"))
                .filter(s -> !s.contains("시원한"))
                .filter(s -> !s.contains("초밥"))
                .filter(s -> !s.contains("밥상"))
                .filter(s -> !s.contains("비빔밥"))
                .filter(s -> !s.contains("행복"))
                .filter(s -> !s.contains("화요리"))
                .filter(s -> !s.contains("족발"))
                .filter(s -> !s.contains("코스"))
                .filter(s -> !s.contains("화로구이"))
                .filter(s -> !s.contains("쭈꾸미"))
                .filter(s -> !s.contains("김치찌개"))
                .filter(s -> !s.contains("해물"))
                .filter(s -> !s.contains("으로"))
                .filter(s -> !s.contains("불백"))
                .filter(s -> !s.contains("사람"))
                .filter(s -> !s.contains("매운"))
                .filter(s -> !s.contains("뚝배기"))
                .filter(s -> !s.contains("스파게티"))
                .filter(s -> !s.contains("즉석떡볶이"))
                .filter(s -> !s.contains("제주"))
                .filter(s -> !s.contains("대치동"))
                .filter(s -> !s.contains("최강"))
                .filter(s -> !s.contains("부대찌개"))
                .filter(s -> !s.contains("2호점"))
                .filter(s -> !s.contains("백반"))
                .filter(s -> !s.contains("분식집"))
                .filter(s -> !s.contains("한식"))
                .filter(s -> !s.contains("짬뽕"))
                .filter(s -> !s.contains("해피"))
                .filter(s -> !s.contains("전골"))
                .collect(toList());
